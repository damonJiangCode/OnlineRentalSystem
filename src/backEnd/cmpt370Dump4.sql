...
CREATE TABLE `customerinfo` (
  ...
  `vegetarian` varchar(45) DEFAULT NULL,
  `vegan` varchar(45) DEFAULT NULL,
  `gluten` varchar(45) DEFAULT NULL,
  `deaf` varchar(45) DEFAULT NULL,
  `blind` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2022-03-28 16:16:19
